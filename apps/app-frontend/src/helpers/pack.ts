...
interface PackLocationCurseForgeVersionId {
	type: 'fromCurseForgeVersionId'
	project_id: number
	file_id: number
	title: string
	icon_url?: string
...
export async function create_profile_and_install_cf(
	projectId: number,
	fileId: number,
	packTitle: string,
	iconUrl?: string,
	...
	const location: PackLocationCurseForgeVersionId = {
		type: 'fromCurseForgeVersionId',
		project_id: projectId,
		file_id: fileId,
		title: packTitle,
